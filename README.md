...
Busca un web de productos donde inspirarte, al igual que en proyecto anterior, la web PcComponentes es un buen lugar para ello. Toma como referencia el listado de productos:
